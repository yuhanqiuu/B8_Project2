...
; This file was generated Fri Mar 29 12:31:54 2024
;--------------------------------------------------------
...
;timeout_cnt               Allocated with name '_main_timeout_cnt_1_123'
...
;	EFM8_JDY40_test.c:485: SendATCommand("AT+VER\r\n");
	mov	dptr,#__str_4
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:486: SendATCommand("AT+BAUD\r\n");
	mov	dptr,#__str_5
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:487: SendATCommand("AT+RFID\r\n");
	mov	dptr,#__str_6
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:488: SendATCommand("AT+DVID\r\n");
	mov	dptr,#__str_7
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:489: SendATCommand("AT+RFC\r\n");
	mov	dptr,#__str_8
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:490: SendATCommand("AT+POWE\r\n");
	mov	dptr,#__str_9
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:491: SendATCommand("AT+CLSS\r\n");
	mov	dptr,#__str_10
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:493: printf("\r\nPress and hold the BOOT button to transmit.\r\n");
	mov	a,#__str_11
	push	acc
	mov	a,#(__str_11 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	EFM8_JDY40_test.c:496: while(1)
	mov	r2,#0x00
	mov	r3,#0x00
L028013?:
;	EFM8_JDY40_test.c:501: volt_x = 10*(Volts_at_Pin(QFP32_MUX_P1_4));
	mov	dpl,#0x0A
	push	ar2
	push	ar3
	lcall	_Volts_at_Pin
...
;	EFM8_JDY40_test.c:502: volt_y = 10*(Volts_at_Pin(QFP32_MUX_P1_5));
	mov	dpl,#0x0B
	lcall	_Volts_at_Pin
	mov	r6,dpl
	mov	r7,dph
	...
	mov	r4,dpl
	mov	r5,dph
;	EFM8_JDY40_test.c:508: sprintf(buff, "%d,%d\r\n", volt_x, volt_y);
	push	ar4
	push	ar5
	...
	add	a,#0xf6
	mov	sp,a
;	EFM8_JDY40_test.c:509: sendstr1(buff);
	mov	dptr,#_buff
	mov	b,#0x40
	lcall	_sendstr1
;	EFM8_JDY40_test.c:510: waitms_or_RI1(200);
	mov	dptr,#0x00C8
	lcall	_waitms_or_RI1
	pop	ar3
	pop	ar2
;	EFM8_JDY40_test.c:512: while(1)
	mov	r4,_main_timeout_cnt_1_123
	mov	r5,(_main_timeout_cnt_1_123 + 1)
L028006?:
;	EFM8_JDY40_test.c:514: if(RXU1()) break; // Got something! Get out of loop.
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	pop	ar2
	jnz	L028022?
;	EFM8_JDY40_test.c:515: Timer3us(100); // Check if something has arrived every 100us
	mov	dpl,#0x64
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	EFM8_JDY40_test.c:516: timeout_cnt++;
	inc	r4
	cjne	r4,#0x00,L028024?
	inc	r5
L028024?:
;	EFM8_JDY40_test.c:518: if(timeout_cnt>=1000) break; // timeout after 100ms, get out of loop
	clr	c
	mov	a,r4
	subb	a,#0xE8
	mov	a,r5
	...
	jc	L028006?
L028022?:
	mov	_main_timeout_cnt_1_123,r4
	mov	(_main_timeout_cnt_1_123 + 1),r5
;	EFM8_JDY40_test.c:525: if(P3_7==0)
	jb	_P3_7,L028009?
;	EFM8_JDY40_test.c:527: sprintf(buff, "JDY40 test %d\r\n", cnt++);
	mov	ar4,r2
	mov	ar5,r3
	inc	r2
	cjne	r2,#0x00,L028027?
	inc	r3
L028027?:
	push	ar2
	push	ar3
	...
	add	a,#0xf8
	mov	sp,a
;	EFM8_JDY40_test.c:528: sendstr1(buff);
	mov	dptr,#_buff
	mov	b,#0x40
	lcall	_sendstr1
;	EFM8_JDY40_test.c:529: putchar('.');
	mov	dpl,#0x2E
	lcall	_putchar
;	EFM8_JDY40_test.c:530: waitms_or_RI1(200);
	mov	dptr,#0x00C8
	lcall	_waitms_or_RI1
	pop	ar3
	pop	ar2
...
;	EFM8_JDY40_test.c:538: getstr1(buff);
	...
	push	ar3
	lcall	_getstr1
;	EFM8_JDY40_test.c:540: printf("%s\r\n",buff);
	mov	a,#_buff
	push	acc
	mov	a,#(_buff >> 8)
	push	acc
